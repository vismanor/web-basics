                            ...
                            <form>
                                <div class="mb-3">
                                    <input name="name" type="text" class="form-control form-control-lg"
                                           id="exampleInputEmail1" placeholder="Имя"
                                ...
                                <button type="button" class="w-100 btn btn-lg btn-success btn-block">Отправить</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <button class="col-4 btn btn-dark btn-lg btn-block mb-4" type="button"
                                        data-bs-toggle="collapse"
                                        data-bs-target="#multiCollapseExample1" aria-expanded="false"
                                        aria-controls="multiCollapseExample1">Как купить?
                                </button>
                                <button class="col-3 btn btn-dark btn-lg btn-block mb-4" type="button"
                                        data-bs-toggle="collapse"
                                ...
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                                        <div class="card card-body">
                                            Заполняйте форму выше, и мы вышлем всю информацию Вам на почту.
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                                        <div class="card card-body">
                                            Доставка в любую точку мира: стоимость рассчитывается индивидуально,
                                            отправление день-в-день службой "Pigeon Express".
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample3">
                                        <div class="card card-body">
                                            Гарантия - 1 год. Ремонт по гарантийным случаям за счет компании.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-header py-3">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>158</td>
                            <td>15 798,42$</td>
                            <td class="alert alert-primary text-white" role="alert">
                                <strong>Новый</strong>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td colspan="1">Jack The Sparrow</td>
                            <td>149,99$</td>
                            <td>133</td>
                            <td>19 948,67$</td>
                            <td class="alert alert-success text-white" role="alert">
